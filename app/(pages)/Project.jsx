...
const Project = () => {
    ...
    const { 
        scrollYProgress
    } = useCustomScroll({ sectionsClassName: "projects" }); //console.log(scrollYProgress); output = 0 to 1 value
    ...
    const ListItem = ({item}) => {
        ...
        return (
            <div ref={ref} className="h-full min-w-full overflow-hidden flex flex-col lg:flex-row lg:gap-[100px] items-center justify-center">
                ...
                <div className="flex flex-col gap-4 p-2 lg:p-0">
                    <h2 className="text-lg lg:text-3xl text-ellipsis line-clamp-2">{item.title}</h2>
    ...
    return (
        <div className="container max-auto lg:pt-[120px] mb-8 lg:mb-0 min-h-[calc(100vh)] h-full relative projects" >
            ...
            <h1>Projects</h1>
            <motion.div 
                className="flex h-full items-center w-full sticky top-0 relative gap-8"
                style={{
